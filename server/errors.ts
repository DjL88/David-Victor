...
export const ErrorCode = {
  ...
  INTEGRATION_CONFIG_INVALID: 'INTEGRATION_CONFIG_INVALID' as BFFErrorCode,
  ...
  WEBHOOK_TENANT_NOT_FOUND: 'WEBHOOK_TENANT_NOT_FOUND' as BFFErrorCode,
  ...
  MENU_PROCESSING: 'MENU_PROCESSING' as BFFErrorCode,
  STALE_MENU_SNAPSHOT: 'STALE_MENU_SNAPSHOT' as BFFErrorCode,
  EMPTY_MENU_SNAPSHOT_REJECTED: 'EMPTY_MENU_SNAPSHOT_REJECTED' as BFFErrorCode,
  ...
  CHECKOUT_IN_PROGRESS: 'CHECKOUT_IN_PROGRESS' as BFFErrorCode,
  CHECKOUT_FAILED: 'CHECKOUT_FAILED' as BFFErrorCode,
  ORDER_NOT_FOUND: 'ORDER_NOT_FOUND' as BFFErrorCode,
  CHECKOUT_NOT_FOUND: 'CHECKOUT_NOT_FOUND' as BFFErrorCode,
  ...
  OPERATIONAL_STATE_LIMIT_EXCEEDED: 'OPERATIONAL_STATE_LIMIT_EXCEEDED' as BFFErrorCode,
  UPSTREAM_DISPATCH_OPERATION_UNSUPPORTED: 'UPSTREAM_DISPATCH_OPERATION_UNSUPPORTED' as BFFErrorCode,
  UPSTREAM_DISPATCH_ERROR: 'UPSTREAM_DISPATCH_ERROR' as BFFErrorCode,
  UPSTREAM_DISPATCH_CONTRACT_INVALID: 'UPSTREAM_DISPATCH_CONTRACT_INVALID' as BFFErrorCode,
  INVALID_FULFILLMENT: 'INVALID_FULFILLMENT' as BFFErrorCode,
  DISPATCH_CHANNEL_LINK_REQUIRED: 'DISPATCH_CHANNEL_LINK_REQUIRED' as BFFErrorCode,
  DISPATCH_ADDRESS_INCOMPLETE: 'DISPATCH_ADDRESS_INCOMPLETE' as BFFErrorCode,
  DISPATCH_QUOTE_REQUIRED: 'DISPATCH_QUOTE_REQUIRED' as BFFErrorCode,
  DISPATCH_DELIVERY_ADDRESS_REQUIRED: 'DISPATCH_DELIVERY_ADDRESS_REQUIRED' as BFFErrorCode,
