...
function parseAuthError(err: any, currentEmail?: string | null): FormattedAuthError {
  ...
  if (
    ...
    return {
      ...
      actionHint: 'Enter your current authenticator code. If this account is not enrolled yet, set up an authenticator app below.',
    };
  }

  // 4. Authenticated with Firebase, but not authorized in RBAC / allowlist
  if (
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-xs font-bold text-indigo-950">
                    {pendingMfaError ? 'Enter your authenticator code' : 'Set up an authenticator app'}
                  </p>
                  <p className="text-[11px] text-indigo-800 mt-1 leading-relaxed">
                    {pendingMfaError
                      ...
                      : 'This administrator session needs TOTP MFA before the BFF will authorize it.'}
                  </p>
                </div>
              </div>
              ...
              {mfaEnrollment && (
                <div className="space-y-2">
                  <p className="text-[11px] text-gray-700">
                    Add this secret to your authenticator app. The provisioning URI is also available below for compatible tools.
                  </p>
                  ...
                  <details className="text-[10px] text-gray-600">
                    <summary className="cursor-pointer font-semibold">Authenticator provisioning URI</summary>
