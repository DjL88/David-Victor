...
describe('API activity journal primitives', () => {
  ...
  it('rejects malformed cursors and preserves valid cursor identity', () => {
    ...
    const encoded = encodeApiActivityCursor({ receivedAt: '2026-09-26T01:00:00Z', id: 'event-1' });
    expect(decodeApiActivityCursor(encoded)).toEqual({ receivedAt: '2026-09-26T01:00:00Z', id: 'event-1' });
  });
