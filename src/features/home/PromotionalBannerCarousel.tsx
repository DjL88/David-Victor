...
export const PromotionalBannerCarousel: React.FC<PromotionalBannerCarouselProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 overflow-x-auto no-scrollbar pb-0.5 px-0.5 w-full max-w-full">
        <div className="flex items-center gap-1.5 p-1 bg-gray-100/90 backdrop-blur-sm rounded-2xl shadow-2xs border border-gray-200/60 shrink-0">
          ...
          >
            ...
            <span>Meal Deals & Multi-Buys</span>
            <span
            ...
            >
              {DELIVERECT_CATALOG_DEALS.length}
            </span>
          </button>
        </div>
      ...
      {/* STANDARDIZED CAROUSEL CONTAINER (IDENTICAL HEIGHT ACROSS ALL 3 VIEWS) */}
      <div className="relative w-full overflow-hidden rounded-3xl shadow-xl h-[420px] sm:h-[440px] md:h-[450px] bg-gray-950">
        ...
        {/* ========================================================= */}
        {/* VIEW 2: MEAL DEALS & MULTI-BUYS (DELIVERECT BUNDLES)       */}
        {/* ========================================================= */}
        {currentTab === 'deals' && (
          <div className="relative h-full w-full bg-gradient-to-br from-gray-950 via-emerald-950/85 to-gray-950 text-white p-4 sm:p-5 md:p-6 flex flex-col justify-between overflow-hidden">
            {/* Header & Controls */}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-sm sm:text-base font-extrabold tracking-tight text-white flex items-center gap-2">
                    <span>Deliverect Meal Deals & Multi-Buys</span>
                  ...
                  <p className="text-[11px] sm:text-xs text-gray-300 line-clamp-1">
                    Bundles & multibuy savings are automatically calculated and deducted from your basket subtotal
                  </p>
                </div>
              </div>
            ...
            {/* Seamless Rolling Carousel Track for Deals */}
            <div
              ref={dealsTrackRef}
            ...
            <div className="flex items-center justify-between pt-1 border-t border-white/10 shrink-0 text-xs text-gray-400">
              <div className="flex items-center gap-1.5">
                {DELIVERECT_CATALOG_DEALS.map((_, idx) => (
                  <span
                    key={`deal-dot-${idx}`}
              ...
              <span className="text-[11px]">Swipe or use arrows to cycle through bundles</span>
            </div>
          </div>
        )}
      </div>
