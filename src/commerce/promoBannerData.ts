...
export const DEFAULT_PROMO_BANNERS: CategoryPromoBanner[] = [
  ...
  // FRESH PRODUCE BANNERS
  {
    ...
    subtitle: 'Picked fresh from trusted local fruit growers. Sweet, vibrant, and packed with vitamins.',
  ...
  return [
    {
      ...
      subtitle: currentCat?.description || `Browse product availability in your local stores.`,
