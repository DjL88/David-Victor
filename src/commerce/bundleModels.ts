...
export const SAMPLE_DELIVERECT_BUNDLES: BundleProduct[] = [
  {
    ...
    badge: 'Combo Deal • Save up to £2.80',
    ...
    sections: [
      ...
      {
        id: 'mg_sides',
        name: 'Choose 1 Side or Dip (Optional)',
        min: 0,
        max: 1,
        multiMin: 0,
        multiMax: 1,
        ...
        modifiers: [
          {
            id: 'mod_garlic_dip',
            name: 'Garlic & Herb Dip 50g',
            plu: 'PLU_GD_50',
            price: 0,
            priceMinor: 0,
            active: true,
            snoozed: false,
            description: 'Creamy garlic and fresh parsley dipping sauce',
          },
          {
            id: 'mod_sweet_chilli_dip',
            name: 'Sweet Chilli Dip 50g',
            plu: 'PLU_SCD_50',
            price: 0,
            priceMinor: 0,
            active: true,
            snoozed: false,
            description: 'Sweet and tangy chilli dip with red pepper flakes',
          },
        ],
      },
      {
